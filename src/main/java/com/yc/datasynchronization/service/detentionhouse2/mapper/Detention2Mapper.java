package com.yc.datasynchronization.service.detentionhouse2.mapper;
...
@Mapper
public interface Detention2Mapper {

    @Select("select * from ryjbxxb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SRyjbxxb> getDt2Ryjbxxb(@Param("rybh") String rybh);

    @Select("select * from rybdxxb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SRybdxxb> getDt2Rybdxxb(@Param("rybh") String rybh);

    @Select("select * from zpb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SZpb> getDt2Zpb(@Param("rybh") String rybh);

    @Delete("delete zpb where rybh = #{rybh}")
    int delDt2Zpb(@Param("rybh") String rybh);
    ...
    int delDt2Rybdxxb(@Param("rybh") String rybh);
