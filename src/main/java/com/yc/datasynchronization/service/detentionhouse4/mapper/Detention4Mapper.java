package com.yc.datasynchronization.service.detentionhouse4.mapper;
...
@Mapper
public interface Detention4Mapper {

    @Select("select * from ryjbxxb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SRyjbxxb> getDt4Ryjbxxb(@Param("rybh") String rybh);

    @Select("select * from rybdxxb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SRybdxxb> getDt4Rybdxxb(@Param("rybh") String rybh);

    @Select("select * from zpb where rybh = #{rybh, jdbcType=VARCHAR}")
    List<SZpb> getDt4Zpb(@Param("rybh") String rybh);

    @Delete("delete zpb where rybh = #{rybh}")
    int delDt4Zpb(@Param("rybh") String rybh);
    ...
    int delDt4Rybdxxb(@Param("rybh") String rybh);
